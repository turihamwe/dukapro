...
<div class="mx-auto max-w-md">
    <x-card class="text-center">
        <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Simulate Mobile Money Payment</h1>
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Local development only — simulates an STK push callback.</p>

        <dl class="mt-6 space-y-3 rounded-xl border border-gray-100 bg-gray-50 p-4 text-left text-sm dark:border-gray-800 dark:bg-gray-800/50">
            <div class="flex justify-between">
                <dt class="text-gray-500">Reference</dt>
                <dd><code class="rounded bg-gray-200 px-1.5 py-0.5 text-xs dark:bg-gray-700">{{ $payment->reference }}</code></dd>
            </div>
            <div class="flex justify-between">

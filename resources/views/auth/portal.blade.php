...
@section('container_class', 'w-full max-w-lg')

@section('content')
    @include('layouts.partials.auth-brand', [
        'subtitle' => 'Find your business portal',
    ])
    ...
    <x-card>
        ...
        <form method="GET" action="#" id="portal-form" class="space-y-5">
            <x-input type="text" name="portal_slug" id="portal_slug" label="Business portal ID" placeholder="e.g. business-name-a1b2c3d4" required large

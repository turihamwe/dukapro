...
<div class="py-8 sm:py-12">
    <div class="mb-8 text-center">
        ...
        <h1 class="text-2xl font-semibold tracking-tight text-gray-900">Welcome to DukaPro</h1>
    ...
    <x-card>
        ...
        <p class="mt-5 text-center text-xs text-gray-500">
            Demo: owner@dukapro.test / password · <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-700">Create account</a>
        </p>
    </x-card>
</div>
@endsection

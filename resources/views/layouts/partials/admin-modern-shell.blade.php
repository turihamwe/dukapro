...
<div class="modern-app flex min-h-screen bg-[#F3F4F6]">
    ...
    <aside id="modern-nav-drawer" class="fixed inset-y-0 left-0 z-50 w-72 -translate-x-full transform bg-[#0A192F] p-4 transition-transform duration-200 lg:hidden">
        <div class="mb-6 flex items-center justify-between">
            ...
            <button type="button" id="modern-nav-close" class="rounded-lg p-2 text-slate-400 hover:bg-white/10" aria-label="Close menu">
        ...
        <header class="sticky top-0 z-30 border-b border-gray-200/80 bg-white/95 px-4 py-3 backdrop-blur-sm sm:px-6 lg:px-8">
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    <button type="button" id="modern-nav-open" class="rounded-lg p-2 text-gray-600 hover:bg-gray-100 lg:hidden" aria-label="Open menu">
                ...
                <div class="flex items-center gap-2 sm:gap-4">
                    ...
                    <button type="button" class="relative rounded-lg p-2 text-gray-500 hover:bg-gray-100" aria-label="Notifications">
                    ...
                    <a href="{{ tenant_route('tenant.profile.edit') }}" class="rounded-lg p-2 text-gray-500 hover:bg-gray-100" aria-label="Settings">

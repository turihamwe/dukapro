...
<form method="POST" action="{{ route('superadmin.settings.update') }}" class="max-w-xl space-y-6">
    ...
    <div class="rounded-xl border border-violet-200 bg-violet-50/50 p-6 space-y-5">
        <div>
            ...
            <p class="mt-1 text-xs text-gray-600">Master switches (level 1). When off, service/rental features stay hidden platform-wide. Unlock individual businesses on their superadmin detail page.</p>
        </div>
